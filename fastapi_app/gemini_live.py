...
class GeminiLive:
    ...
    def __init__(self, api_key, model, input_sample_rate, tools=None, tool_mapping=None, system_instruction=None):
        ...
        Args:
            ...
            system_instruction (types.Content, optional): Custom system instructions.
        """
    ...
    async def start_session(self, audio_input_queue, video_input_queue, text_input_queue, audio_output_callback, audio_interrupt_callback=None):
        config = types.LiveConnectConfig(
            ...
            system_instruction=self.system_instruction or types.Content(parts=[types.Part(text="You are a helpful AI assistant. Keep your responses concise. Speak in a friendly Irish accent. You can see the user's camera or screen which is shared as realtime input images with you.")]),
